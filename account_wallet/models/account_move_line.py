...
class AccountMoveLine(models.Model):
    ...
    def wallet_value(self, vals_list):
        ...
        for values in vals_list:
            if not values.get('account_wallet_id'):
                ...
                values['partner_id'] = wallet.partner_id.id or \
    ...
    def _check_wallet_account(self):
        ...
        """
        if any(line.account_wallet_id and
               line.account_wallet_id.wallet_type_id.account_id !=
               line.account_id for line in self):
