...
class hr_utilization_report(report_sxw.rml_parse):
    ...
    def set_context(self, objects, data, ids, report_type = None):
        ...
        self.cr.execute("""
            select al.user_id, al.account_id, p.name, r.company_id, c.id, sum(al.unit_amount)
              ...
              group by al.user_id, al.account_id, p.name, r.company_id, c.id
              order by p.name""", (data['period_start'], data['period_end']))
